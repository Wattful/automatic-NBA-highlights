...
public class ConjunctiveConstraint implements Constraint {
	...
	*/
	public ConjunctiveConstraint(Constraint... c){
		if(c.length == 0){
	...
	*/
	public boolean equals(Object o){
		...
		if(!(o instanceof ConjunctiveConstraint)){
			return false;
		}
		ConjunctiveConstraint dc = (ConjunctiveConstraint)o;
