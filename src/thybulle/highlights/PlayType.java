...
public enum PlayType implements Constraint {
	UNKNKOWN(0), 
	FIELD_GOAL_ATTEMPT(1), FIELD_GOAL_MISSED(1, FIELD_GOAL_ATTEMPT), FIELD_GOAL(1, FIELD_GOAL_ATTEMPT), AND_ONE(1, FIELD_GOAL), 
	DUNK_ATTEMPT(1, FIELD_GOAL_ATTEMPT), DUNK(1, FIELD_GOAL, DUNK_ATTEMPT), MISSED_DUNK(1, DUNK_ATTEMPT, FIELD_GOAL_MISSED), AND_ONE_DUNK(1, DUNK, AND_ONE), 
	THREE_POINTER_ATTEMPT(1, FIELD_GOAL_ATTEMPT), THREE_POINTER_MISSED(1, THREE_POINTER_ATTEMPT, FIELD_GOAL_MISSED), THREE_POINTER(1, FIELD_GOAL, THREE_POINTER_ATTEMPT), 
	AND_ONE_THREE_POINTER(1, THREE_POINTER, AND_ONE),
	...
	TEAM_TURNOVER(0, TURNOVER), SHOT_CLOCK_VIOLATION(0, TEAM_TURNOVER), EIGHT_SECOND_VIOLATION(1, TEAM_TURNOVER),
	...
	DEFENSIVE_FOUL(1, FOUL), SHOOTING_FOUL(1, DEFENSIVE_FOUL), LOOSE_BALL_FOUL(1, FOUL), OFFENSIVE_FOUL(1, FOUL, TURNOVER),
	JUMP_BALL(2), 
	GOALTENDING(1),
	SUBSTITUTION(2),
	TIMEOUT(0);
