...
public class DisjunctiveConstraint implements Constraint {
	...
	*/
	public DisjunctiveConstraint(Constraint... c){
		if(c.length == 0){
	...
	*/
	public boolean equals(Object o){
		...
		if(!(o instanceof DisjunctiveConstraint)){
			return false;
		}
		DisjunctiveConstraint dc = (DisjunctiveConstraint)o;
